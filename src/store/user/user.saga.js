...
export function* signInWithEamil({ payload: { email, password }}) {
    try {
...
export function* onEmailSignInStart() {
    yield takeLatest(USER_ACTION_TYPES.EMAIL_SIGN_IN_START, signInWithEamil);
}
...
export function* onSignUpFailed() {
    yield takeLatest(USER_ACTION_TYPES.SIGN_UP_FAILED, )
}
